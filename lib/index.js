...
const { Merk, verifyProof, Restorer } = require(`../build/${process.platform}.node`)
...
module.exports.restore = function createRestorer(path, expectedRootHash, statedLength) {
  return new Restorer(path, expectedRootHash, statedLength)
}